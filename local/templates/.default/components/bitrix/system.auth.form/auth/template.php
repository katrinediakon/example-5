	...
	<table width="95%">
		<tr>
			<td align="center">
				...
				<a style="color:black" href="<?=$arResult["PROFILE_URL"]?>" >	<?=$arResult["USER_NAME"]?>
		...
		<tr>
			...
			<input class="button_vhod" type="submit" name="logout_butt" value="<?=GetMessage("AUTH_LOGOUT_BUTTON")?>" />
			</td>
		</tr>
	</table>
</form>
